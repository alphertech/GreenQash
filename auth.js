...
// Initialize Supabase client// auth.js - Fixed database integration
import { createClient } from 'https://cdn.jsdelivr.net/npm/@supabase/supabase-js/+esm'
        ...
        const { data, error } = await supabase
            ...
            .insert([
                { 
                    ...
                    email_address: email
                    // Let the database handle the auto-increment ID and created_at
                }
            ])
            .select()
            
        if (error) {
            // If it's a duplicate error, that's okay - user already exists
            if (error.code === '23505') {
